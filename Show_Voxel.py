...
def plot_voxel_comparison(voxel_original, voxel_reconstruction, voxel_res=None):
    fig = pyplot.figure()

    ax = fig.add_subplot(121, projection='3d')
    ax.scatter(voxel_original[:, 0], voxel_original[:, 1], voxel_original[:, 2])
    ax.set_xlabel('X Label')
    ax.set_ylabel('Y Label')
    ax.set_zlabel('Z Label')
    ax.set_title('voxel original')
    ...
    ax.scatter(voxel_reconstruction[:, 0], voxel_reconstruction[:, 1], voxel_reconstruction[:, 2])
    ax.set_xlabel('X Label')
    ax.set_ylabel('Y Label')
    ax.set_zlabel('Z Label')
    ax.set_title('voxel reconstruction')
